$(document).ready(function(){
  ...
  SafeRoute.RoutesController.initialize(SafeRoute.RoutesModel, SafeRoute.RoutesView, SafeRoute.MapsController, SafeRoute.CrimesController, directionsService, directionsDisplay);
