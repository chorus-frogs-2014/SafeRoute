$(document).ready(function(){
  ...
  SafeRoute.MasterController.initialize(SafeRoute.MapsController, SafeRoute.MapsView, SafeRoute.CrimesController, SafeRoute.RouteController, directionsDisplay);
